...
```bash
[[basil@basil@centos7-vm ] sysconfig]\# ls -l
...
-rw-r--r--. 1 root root   39 Dec 11 19:49 watchlog
[[basil@basil@centos7-vm ] sysconfig]\# vim watchlog
WORD="ALERT"
...
```bash
[[basil@basil@centos7-vm ] sysconfig]\# touch /var/log/watchlog.log
[[basil@basil@centos7-vm ] sysconfig]\# ls -l /var/log
...
...
```bash
[[basil@basil@centos7-vm ] sysconfig]\# touch /opt/watchlog.sh
[[basil@basil@centos7-vm ] sysconfig]\# vim /opt/watchlog.sh
...
```bash
[[basil@basil@centos7-vm ] ~]\# touch watchlog.service
[[basil@basil@centos7-vm ] ~]\# vim watchlog.service
[[basil@basil@centos7-vm ] ~]\# cat watchlog.service
[Unit]
...
```bash
[[basil@basil@centos7-vm ] ~]\# touch watchlog.timer
[[basil@basil@centos7-vm ] ~]\# vim watchlog.timer
[[basil@basil@centos7-vm ] ~]\# cat watchlog.timer
[Unit]
...
```bash
[[basil@basil@centos7-vm ] system]\# systemctl start watchlog.timer
[[basil@basil@centos7-vm ] system]\# tail -f /var/log/messages
...
[[basil@basil@centos7-vm ] system]\# cat /etc/sysconfig/spawn-fcgi
...
[[basil@basil@centos7-vm ] system]\# cat /etc/systemd/system/spawn-fcgi.service
[Unit]
...
[[basil@basil@centos7-vm ] system]# systemctl start spawn-fcgi
[[basil@basil@centos7-vm ] system]# systemctl status spawn-fcgi
...
```bash
[[basil@basil@centos7-vm ] system]# cat httpd.service
[Unit]
...
```bash
[[basil@basil@centos7-vm ] system]\# cat /etc/sysconfig/httpd-first
OPTIONS="-f conf/first.conf"
[[basil@basil@centos7-vm ] system]\# cat /etc/sysconfig/httpd-second
OPTIONS="-f conf/second.conf"

[[basil@basil@centos7-vm ] system]\# cat /etc/sysconfig/conf/first.conf
PidFile /var/run/httpd-first.pid
Listen 80
[[basil@basil@centos7-vm ] system]\# cat /etc/sysconfig/conf/second.conf
